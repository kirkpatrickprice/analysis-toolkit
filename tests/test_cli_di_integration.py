...
class TestCLIDependencyInjection:
    ...
    def test_cli_passes_quiet_to_di(self, mock_init_di: MagicMock) -> None:
        ...
        runner = CliRunner()
        result = runner.invoke(cli, ["--quiet", "--skip-update-check"])
...
class TestCLIErrorHandling:
    ...
    def test_cli_help_works_without_di(self) -> None:
...
class TestCLISubcommandIntegration:
    ...
    def test_scripts_subcommand_exists(self) -> None:
    ...
    def test_nipper_subcommand_exists(self) -> None:
    ...
    def test_rtf_to_text_subcommand_exists(self) -> None:
        """Test that rtf-to-text subcommand is available."""
        runner = CliRunner()
        result = runner.invoke(cli, ["rtf-to-text", "--help"])
    ...
    def test_subcommands_benefit_from_di_initialization(
        ...
        runner.invoke(cli, ["scripts", "--help"])
