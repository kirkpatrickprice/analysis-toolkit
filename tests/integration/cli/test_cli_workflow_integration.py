...
class TestCLIVersionChecking:
    ...
    def test_cli_calls_version_check_by_default(self, mock_check_update: Mock, cli_runner: CliRunner) -> None:
    ...
    @patch("kp_analysis_toolkit.cli.main.check_and_prompt_update")
    def test_subcommands_trigger_version_check(self, mock_check_update: Mock, cli_runner: CliRunner) -> None:
