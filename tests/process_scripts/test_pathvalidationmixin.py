...
class TestPathValidationMixin:
    ...
    def test_validate_path_exists_with_existing_path(self, tmp_path) -> None:
    ...
    def test_validate_file_exists_with_existing_file(self, tmp_path) -> None:
    ...
    def test_validate_file_exists_with_directory(self, tmp_path) -> None:
    ...
    def test_validate_directory_exists_with_existing_directory(self, tmp_path) -> None:
    ...
    def test_validate_directory_exists_with_file(self, tmp_path) -> None:
