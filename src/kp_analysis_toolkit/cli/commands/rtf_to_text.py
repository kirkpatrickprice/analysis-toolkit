...
def _process_all_files_with_service(
    ...
    """Process all RTF files using the core batch processing service."""
    # Create success message formatter using the new service
    ...
    # Process files using the core batch processing service
